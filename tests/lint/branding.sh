...
EXCLUDE_RE='^(os/rootfs/usr/share/meridian/branding\.json|os/rootfs/usr/share/plasma/desktoptheme|docs|STATUS\.md|CONTRIBUTING-AGENTS\.md|README\.md|tests/lint/branding\.sh)(/|$)'
